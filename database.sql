...
INSERT INTO "item" ("description", "category", "aircraft_id")
VALUES ('Fuel Shutoff Valve: Open', 'before-engine', '1'), ('Brakes: Test & Set', 'before_engine', '1'); 
...
SELECT * FROM "item" WHERE "aircraft_id" = 1 AND "category" = 'before_engine';

ALTER TABLE "item"
ADD "action" VARCHAR (80);

SELECT * FROM "item" WHERE "aircraft_id" = 1 ORDER BY "category";

DELETE FROM "item" WHERE "id" = 46;

SELECT * FROM "aircraft" WHERE "id" = 2;